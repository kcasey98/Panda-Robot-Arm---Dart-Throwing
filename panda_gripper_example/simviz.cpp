...
void simulation(Sai2Model::Sai2Model* robot, Simulation::Sai2Simulation* sim)
{
    ...
    while (fSimulationRunning) {
        ...
        // if bullseye hasn't been hit yet
        if (hit == false){
            // for each object
            for (int i = 0; i < n_objects; ++i) {
                ...
                // if the dart is moving at a certain speed, take over simulation trajectory
                ...
                if (bd == true){
                    ...
                    // this freezes the dart at the bullseye
                    if (object_pos[0](1) > 0.965 && target == "1"){
                        cout << "1" << endl;
                        hit = true;
                        dart_hit(0) = object_pos[i](0);
                        dart_hit(1) = object_pos[i](1);
                        dart_hit(2) = 1.1;  //1.1;  // this is Kyle's hacky way to ensure bullseye
                        break;
                    }
                    ...
                    if (object_pos[0](1) > 3.965 && target == "4"){
                        ...
                        cout << "dart hit coord" << object_pos[i] << endl;
                        break;
                    }
                }
            }
